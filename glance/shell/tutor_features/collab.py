"""
Live collaboration — share a Glance session with a friend over WebRTC.
...
How users would use it once finished:
    ...
    │ Both Glances now share:         │    │ Both Glances now share:       │
...
class CollabSession:
    ...
    SIGNALLING_URL = "wss://glance-signal.example/v1"   # TODO: stand up server
