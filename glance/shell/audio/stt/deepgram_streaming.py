...
def _ws_url() -> str:
    ...
    GLANCE_STT_KEYTERMS (comma-separated, e.g. 'FL Studio,Premiere')."""
    import os
    from urllib.parse import quote
    terms = ["Glance"]
    extra = os.environ.get("GLANCE_STT_KEYTERMS", "")
...
class DeepgramStreamingSession:
    ...
    async def start(self) -> bool:
        ...
        try:
            ...
            print(f"[glance-debug] deepgram stream connect failed: {e}", flush=True)
            self._ws = None
            return False
