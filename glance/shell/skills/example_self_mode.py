...
Action:   asks Glance's manager to actually click the next pointed element
          instead of just hovering on it.

Copy this file to ~/.glance/skills/ and edit, or write your own.
"""
...
SKILL = {
    ...
    "description": "Lets Glance click the element it points at.",
