"""
Hybrid pointer — Glance pointing accuracy upgrade.
...
pick a neighboring cell or off-by-one row, sending Glance's blue cursor to
the wrong button.
...
log = logging.getLogger("glance.pointer")
...
def find_target(
    ...
    *,
    ...
    Args:
        query:        what the user asked Glance to point at (e.g. "save button",
