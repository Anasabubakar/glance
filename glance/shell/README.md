...
| `GLANCE_HOTKEY` | `ctrl+alt+m` | Global push-to-talk combo |
| `GLANCE_STT` | *(auto)* | Force STT: `deepgram`/`openai`/`whisper_cpp`/`faster_whisper` |
| `GLANCE_ACTIVE_LLM` | *(auto)* | Force LLM: `claude`/`openai`/`copilot`/`gemini`/`ollama` |
