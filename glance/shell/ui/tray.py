...
class TrayManager(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self._tray.setToolTip(
            f"Glance - AI Companion\nHold {cfg.hotkey} to speak"
        )
        self._search_enabled = True
        # GLANCE_WAKE_WORD=0 starts with the wake word off (e.g. demo recording,
        # where narration says "Glance" while she's idle). Tray toggle still works.
        import os as _os
        self._wake_enabled = _os.environ.get("GLANCE_WAKE_WORD", "1") != "0"
    ...
    def _build_menu(self):
        ...
        wake_action = menu.addAction(
            "Wake word 'Glance': ON" if self._wake_enabled else "Wake word 'Glance': OFF"
        )
        ...
        wf_stop  = wf_menu.addAction("Stop + send to Glance")
        ...
        quit_action = menu.addAction("Quit Glance")
    ...
    def _toggle_wake(self, checked: bool):
        ...
        self._wake_action.setText(
            "Wake word 'Glance': ON" if checked else "Wake word 'Glance': OFF"
        )
